...
const QA_ICONS = {
  ...
  tv:<><path d="M8 6L5 3M16 6l3-3"/><rect x="3" y="6" width="18" height="14" rx="2"/><circle cx="12" cy="13" r="3.4"/><path d="M12 9.6v1M12 16.4v-1"/><circle cx="17.6" cy="9.6" r=".9" fill="currentColor" stroke="none"/><circle cx="17.6" cy="12.4" r=".9" fill="currentColor" stroke="none"/><path d="M16.8 15.4h1.6M16.8 17h1.6"/></>,
};
